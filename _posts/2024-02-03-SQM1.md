...
이 글에서는 초대칭의 존재를 가정함으로써 얻어질 수 있는 model-independent한 결과들에 대해 설명하고, 가장 단순한 example에서 이 결과들의 realization을 확인한다. 이 시리즈의 앞부분에서는 항상 nonrelativistic한 경우만을 생각할 것이다.
